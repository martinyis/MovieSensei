    ...
    <header>
        ...
        <div className="h-[100%] flex justify-between items-center mx-auto max-w-[1120px]">
          ...
          <div className="flex gap-[48px] items-center">
            <ul className="flex gap-[48px] lg:gap-[20px]">
              <Link to="/">
                <li className="hover:text-[#610094]">Home</li>
              </Link>
              <Link to="/generation">
                <li className="hover:text-[#610094]">Generate</li>
              </Link>
              <Link to="/pricing">
                <li className="hover:text-[#610094]">Buy Credits</li>
              </Link>
      ...
      <nav className="hidden md:block h-[64px] bg-[#000000] w-[100%] px-10 sm:px-5 absolute top-0 z-50">
        ...
        <div
          ...
          } -translate-x-1/2 flex items-center pt-[100px] bg-[#000000] h-screen w-[100%]`}
